  ...
  return (
    <footer className="border-t border-border py-10 md:py-14">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 text-center">
        ...
        <p className="text-muted-foreground text-sm mb-6">Study smarter. Move faster.</p>
        ...
        <p className="text-xs text-muted-foreground">&copy; 2026 SprintAI. All rights reserved.</p>
      </div>
    </footer>
  );
}
